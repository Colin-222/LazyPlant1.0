...
public class DialogHelper {
    ...
    public static void openPlantNotesPopup(final GardenPlant gp, Context context,
                                           DialogInterface.OnDismissListener onDismissListener){
        final Context f_context = context;
        final String pid = gp.getPlant_id();
        AlertDialog.Builder builder = new AlertDialog.Builder(context, R.style.NoteAlertDialogStyle);
        builder.setTitle("Add notes for: " + gp.getName());
        ...
        final String current = gp.getNotes();
        ...
        builder.setPositiveButton("Save", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                if(current != null){
                    gp.setNotes(input.getText().toString());
                    dao.update(gp);
                }
